  ...
  return (
    <TooltipProvider>
      <aside className="flex flex-col h-full bg-slate-950/20 backdrop-blur-3xl border-r border-white/5 w-80 shrink-0">
        ...
        <div className={cn("px-8 mt-2 transition-all duration-500 flex flex-col min-h-0", isChatsMax ? "flex-1" : "")}>
          ...
          <div className={cn(
            ...
            !isChatsOpen ? "h-0 opacity-0 mb-0 pointer-events-none" : isChatsMax ? "flex-1 mb-6" : "h-[180px] mb-6"
          )}>
        ...
        <div className={cn(
          "px-8 transition-all duration-500 flex flex-col min-h-0", 
          isDocsMax ? "flex-1" : (isChatsMax || isTrendingMax) ? "h-0 opacity-0 pointer-events-none overflow-hidden" : "mt-6"
        )}>
          <div className="flex items-center justify-between px-1 mb-4 flex-none">
          ...
          <div className={cn(
              "overflow-hidden transition-all duration-500",
              !isDocsOpen ? "h-0 opacity-0 pointer-events-none" : isDocsMax ? "flex-1" : "h-[220px]"
            )}>
            <ScrollArea className="h-full pr-4">
        ...
        {!isChatsMax && !isDocsMax && trending.length > 0 && (
            <div className={cn(
              "px-8 transition-all duration-500 flex flex-col min-h-0",
              isTrendingMax ? "flex-1 pb-6" : "mt-auto pt-6 pb-4 border-t border-white/5 bg-slate-950/20"
            )}>
                <div className="flex items-center justify-between px-1 mb-4 flex-none">
                ...
                <div className={cn(
                  "overflow-hidden transition-all duration-500",
                  !isTrendingOpen ? "h-0 opacity-0 pointer-events-none" : isTrendingMax ? "flex-1" : "max-h-[160px]"
                )}>
